...
class ABP_MenuGameMode_C final : public AGameModeBase
{
public:
...
static_assert(sizeof(ABP_MenuGameMode_C) == 0x0002C8, "Wrong size on ABP_MenuGameMode_C");
static_assert(offsetof(ABP_MenuGameMode_C, DefaultSceneRoot) == 0x0002C0, "Member 'ABP_MenuGameMode_C::DefaultSceneRoot' has a wrong offset!");
