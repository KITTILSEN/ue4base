...
#include "BT_GB_Ky_StartADS_classes.hpp"
#include "BT_GB_Ky_StartADS_parameters.hpp"
...
EKytBTEnterResult UBT_GB_Ky_StartADS_C::DoEnter(class AKytController* Controller, class UKytBlackboard* BehaviorBlackboard)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BT_GB_Ky_StartADS_C", "DoEnter");

	Params::BT_GB_Ky_StartADS_C_DoEnter Parms{};
