...
namespace Offsets
{
	constexpr int32 GObjects          = 0x06B96C30;
	constexpr int32 AppendString      = 0x02106020;
	constexpr int32 GNames            = 0x06B5A5C0;
	constexpr int32 GWorld            = 0x068FB218;
	constexpr int32 ProcessEvent      = 0x02359B60;
