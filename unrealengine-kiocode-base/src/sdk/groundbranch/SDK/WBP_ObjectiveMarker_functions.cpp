...
#include "WBP_ObjectiveMarker_classes.hpp"
#include "WBP_ObjectiveMarker_parameters.hpp"
...
void UWBP_ObjectiveMarker_C::ExecuteUbergraph_WBP_ObjectiveMarker(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_ObjectiveMarker_C", "ExecuteUbergraph_WBP_ObjectiveMarker");

	Params::WBP_ObjectiveMarker_C_ExecuteUbergraph_WBP_ObjectiveMarker Parms{};
...
void UWBP_ObjectiveMarker_C::Construct()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("WBP_ObjectiveMarker_C", "Construct");
...
void UWBP_ObjectiveMarker_C::CalcPosition(const struct FVector& InLocation, struct FVector2D* OutCanvasPosition)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("WBP_ObjectiveMarker_C", "CalcPosition");

	Params::WBP_ObjectiveMarker_C_CalcPosition Parms{};
...
struct FSlateBrush UWBP_ObjectiveMarker_C::GetBackground_Border()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("WBP_ObjectiveMarker_C", "GetBackground_Border");

	Params::WBP_ObjectiveMarker_C_GetBackground_Border Parms{};
...
// int32*                                  LevelNumber_0                                          (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// float*                                  ModifierSpriteRotation                                 (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_ObjectiveMarker_C::ParseObjectiveNameForModifier(const class FString& ObjectiveName, class FString* CleanObjectiveName, class UTexture2D** ModifierSprite, bool* DisplayStaircaseIcon, bool* DisplayLevelNumberText, int32* LevelNumber_0, float* ModifierSpriteRotation)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_ObjectiveMarker_C", "ParseObjectiveNameForModifier");

	Params::WBP_ObjectiveMarker_C_ParseObjectiveNameForModifier Parms{};
	...
	if (LevelNumber_0 != nullptr)
		*LevelNumber_0 = Parms.LevelNumber_0;
