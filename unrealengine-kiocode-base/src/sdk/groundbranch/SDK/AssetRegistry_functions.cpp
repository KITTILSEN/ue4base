...
void IAssetRegistry::ScanPathsSynchronousNoCache(const TArray<class FString>& InPaths, bool bForceRescan)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("AssetRegistry", "ScanPathsSynchronousNoCache");

	Params::AssetRegistry_ScanPathsSynchronousNoCache Parms{};
