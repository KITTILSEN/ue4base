...
// class ULoadingProcessTask*              ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void ULoadingScreenManager::K2_SetLoadingScreenCustomText(class UObject* WorldContextObject, const class FString& NewText)
{
	static class UFunction* Func = nullptr;
