...
#include "BT_GB_Ky_StartProne_classes.hpp"
#include "BT_GB_Ky_StartProne_parameters.hpp"
...
EKytBTEnterResult UBT_GB_Ky_StartProne_C::DoEnter(class AKytController* Controller, class UKytBlackboard* BehaviorBlackboard)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BT_GB_Ky_StartProne_C", "DoEnter");

	Params::BT_GB_Ky_StartProne_C_DoEnter Parms{};
