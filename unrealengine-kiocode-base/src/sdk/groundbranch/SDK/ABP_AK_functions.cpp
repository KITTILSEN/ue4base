...
#include "ABP_AK_classes.hpp"
#include "ABP_AK_parameters.hpp"
...
void UABP_AK_C::ExecuteUbergraph_ABP_AK(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ABP_AK_C", "ExecuteUbergraph_ABP_AK");

	Params::ABP_AK_C_ExecuteUbergraph_ABP_AK Parms{};
...
void UABP_AK_C::OnFiringModeIndexChanged(uint8 FiringModeIndex)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ABP_AK_C", "OnFiringModeIndexChanged");

	Params::ABP_AK_C_OnFiringModeIndexChanged Parms{};
...
void UABP_AK_C::OnSetFrontSightPostHeightOffset(float FrontSightPostHeightOffset_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ABP_AK_C", "OnSetFrontSightPostHeightOffset");

	Params::ABP_AK_C_OnSetFrontSightPostHeightOffset Parms{};
...
void UABP_AK_C::OnIronSightZeroing(const struct FVector& ZeroRelativeToSight, const struct FVector& SightLocationOffset, const struct FRotator& SightRotationOffset)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ABP_AK_C", "OnIronSightZeroing");

	Params::ABP_AK_C_OnIronSightZeroing Parms{};
...
void UABP_AK_C::AnimGraph(struct FPoseLink* AnimGraph_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ABP_AK_C", "AnimGraph");

	Params::ABP_AK_C_AnimGraph Parms{};
