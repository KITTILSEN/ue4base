...
public:
	...
	TArray<struct FMotionWarpingTarget>           WarpTargets;                                       // 0x00E0(0x0010)(Net, ZeroConstructor, Transient, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMotionWarpingComponent) == 0x0000F0, "Wrong size on UMotionWarpingComponent");
static_assert(offsetof(UMotionWarpingComponent, bSearchForWindowsInAnimsWithinMontages) == 0x0000B0, "Member 'UMotionWarpingComponent::bSearchForWindowsInAnimsWithinMontages' has a wrong offset!");
static_assert(offsetof(UMotionWarpingComponent, OnPreUpdate) == 0x0000B8, "Member 'UMotionWarpingComponent::OnPreUpdate' has a wrong offset!");
static_assert(offsetof(UMotionWarpingComponent, CharacterOwner) == 0x0000C8, "Member 'UMotionWarpingComponent::CharacterOwner' has a wrong offset!");
static_assert(offsetof(UMotionWarpingComponent, Modifiers) == 0x0000D0, "Member 'UMotionWarpingComponent::Modifiers' has a wrong offset!");
static_assert(offsetof(UMotionWarpingComponent, WarpTargets) == 0x0000E0, "Member 'UMotionWarpingComponent::WarpTargets' has a wrong offset!");
...
public:
	...
	struct FTransform                             CachedMeshTransform;                               // 0x01B0(0x0030)(IsPlainOldData, NoDestructor, Protected, NativeAccessSpecifierProtected)
	struct FTransform                             CachedMeshRelativeTransform;                       // 0x01E0(0x0030)(IsPlainOldData, NoDestructor, Protected, NativeAccessSpecifierProtected)
	struct FTransform                             CachedRootMotion;                                  // 0x0210(0x0030)(IsPlainOldData, NoDestructor, Protected, NativeAccessSpecifierProtected)
