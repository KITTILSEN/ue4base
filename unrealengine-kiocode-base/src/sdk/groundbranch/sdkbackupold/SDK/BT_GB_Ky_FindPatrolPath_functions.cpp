...
#include "BT_GB_Ky_FindPatrolPath_classes.hpp"
#include "BT_GB_Ky_FindPatrolPath_parameters.hpp"
...
EKytBTEnterResult UBT_GB_Ky_FindPatrolPath_C::DoEnter(class AKytController* Controller, class UKytBlackboard* BehaviorBlackboard)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BT_GB_Ky_FindPatrolPath_C", "DoEnter");

	Params::BT_GB_Ky_FindPatrolPath_C_DoEnter Parms{};
