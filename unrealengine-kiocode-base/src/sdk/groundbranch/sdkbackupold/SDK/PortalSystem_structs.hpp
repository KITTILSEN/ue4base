...
static_assert(alignof(FBasicLine) == 0x000004, "Wrong alignment on FBasicLine");
static_assert(sizeof(FBasicLine) == 0x000018, "Wrong size on FBasicLine");
static_assert(offsetof(FBasicLine, Start) == 0x000000, "Member 'FBasicLine::Start' has a wrong offset!");
static_assert(offsetof(FBasicLine, End) == 0x00000C, "Member 'FBasicLine::End' has a wrong offset!");
