...
#include "BT_Ky_CheckReload_classes.hpp"
#include "BT_Ky_CheckReload_parameters.hpp"
...
EKytBTEnterResult UBT_Ky_CheckReload_C::DoEnter(class AKytController* Controller, class UKytBlackboard* BehaviorBlackboard)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BT_Ky_CheckReload_C", "DoEnter");

	Params::BT_Ky_CheckReload_C_DoEnter Parms{};
