...
static_assert(alignof(PortalSystemZone_ContainPoint) == 0x000004, "Wrong alignment on PortalSystemZone_ContainPoint");
static_assert(sizeof(PortalSystemZone_ContainPoint) == 0x000010, "Wrong size on PortalSystemZone_ContainPoint");
...
static_assert(offsetof(PortalSystemZone_ContainPoint, ReturnValue) == 0x00000C, "Member 'PortalSystemZone_ContainPoint::ReturnValue' has a wrong offset!");
