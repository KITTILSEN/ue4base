...
// Function AssetRegistry.AssetRegistry.ScanPathsSynchronousNoCache
// 0x0018 (0x0018 - 0x0000)
struct AssetRegistry_ScanPathsSynchronousNoCache final
{
public:
	TArray<class FString>                         InPaths;                                           // 0x0000(0x0010)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
	bool                                          bForceRescan;                                      // 0x0010(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(AssetRegistry_ScanPathsSynchronousNoCache) == 0x000008, "Wrong alignment on AssetRegistry_ScanPathsSynchronousNoCache");
static_assert(sizeof(AssetRegistry_ScanPathsSynchronousNoCache) == 0x000018, "Wrong size on AssetRegistry_ScanPathsSynchronousNoCache");
static_assert(offsetof(AssetRegistry_ScanPathsSynchronousNoCache, InPaths) == 0x000000, "Member 'AssetRegistry_ScanPathsSynchronousNoCache::InPaths' has a wrong offset!");
static_assert(offsetof(AssetRegistry_ScanPathsSynchronousNoCache, bForceRescan) == 0x000010, "Member 'AssetRegistry_ScanPathsSynchronousNoCache::bForceRescan' has a wrong offset!");
