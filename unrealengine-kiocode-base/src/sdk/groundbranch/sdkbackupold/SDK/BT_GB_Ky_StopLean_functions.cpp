...
#include "BT_GB_Ky_StopLean_classes.hpp"
#include "BT_GB_Ky_StopLean_parameters.hpp"
...
EKytBTEnterResult UBT_GB_Ky_StopLean_C::DoEnter(class AKytController* Controller, class UKytBlackboard* BehaviorBlackboard)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BT_GB_Ky_StopLean_C", "DoEnter");

	Params::BT_GB_Ky_StopLean_C_DoEnter Parms{};
